 <?php       
        ...
        $filepath = "" . __DIR__ . "/wp-content/uploads/download-manager-files/2016 April General Conference.csv";
        //echo $filepath;
...
FROM (
    SELECT 
        MAX( CASE WHEN wp_postmeta.meta_key = "file_title"
    ...
    AND `wt`.`slug`IN ("general-womens-session-april-2016"
                      ,"saturday-morning-session-april-2016"
                      ,"saturday-afternoon-session-april-2016"
                      ,"general-priesthood-session-april-2016"
                      ,"sunday-morning-session-april-2016"
                      ,"sunday-afternoon-session-april-2016")
